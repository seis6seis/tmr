...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2013 a las 15:30:49
...
('CP', 'VARCHAR', 5, 'TEXT', 5, 0, 'txtCP', 'CP', 1, 1, 24, ''),
...
('Fecha Estimada Compra Moviles', 'VARCHAR', 0, 'TEXT', 7, 0, 'txtFechaEstimadaCompraMoviles', 'FechaEstimadaCompraMoviles', 0, 5, 4, ''),
...
('Opp Impresion €', 'INT', 50, 'NUMBER', 20, 0, 'txtOppImpresion', 'OppImpresion', 0, 6, 3, ''),
('Opp LFD €', 'INT', 50, 'NUMBER', 20, 0, 'txtOppLFD', 'OppLFD', 0, 7, 3, ''),
('Opp Moviles €', 'INT', 50, 'NUMBER', 20, 0, 'txtOppMoviles', 'OppMoviles', 0, 5, 3, ''),
('Opp PCs €', 'INT', 50, 'NUMBER', 20, 0, 'txtOppPCs', 'OppPCs', 0, 3, 3, ''),
('Opp Tablets €', 'VARCHAR', 50, 'TEXT', 20, 0, 'txtOppTablets', 'OppTablets', 0, 4, 3, ''),
...
('Resumen de la Conversación', 'VARCHAR', 0, 'TEXT', 20, 0, 'txtResumenConversacion', 'ResumenConversacion', 0, 2, 7, '');
