...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2013 a las 19:09:32
...
CREATE TABLE IF NOT EXISTS `disenotabla` (
  ...
  `Editable` tinyint(1) DEFAULT '1' COMMENT '0 Si no se podra editar dicho campo; 1 si se podra editar',
...
INSERT INTO `disenotabla` (`Titulo`, `Tipo`, `TamanoTabla`, `tipoPantalla`, `TamanoPantalla`, `Clave`, `Name`, `NameBBDD`, `Requerido`, `Editable`, `Columna`, `Posicion`, `Default`, `ColumnaCSV`) VALUES
('¿Con qué Marcas de Impresion Trabaja Habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtMarcarImpresion', 'MarcarImpresion', 1, 1, 6, 6, '', 77),
('¿Con qué Marcas de LFD Trabaja Habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtMarcarLFD', 'MarcarLFD', 1, 1, 7, 6, '', 83),
('¿Con qué Marcas de Moviles Trabaja Habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtMarcarMoviles', 'MarcarMoviles', 1, 1, 5, 6, '', 71),
('¿Con qué Marcas de PCs Trabaja Habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtMarcarPCs', 'MarcarPCs', 1, 1, 3, 6, '', 59),
('¿Con qué Marcas de Tablets Trabaja Habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtMarcarTablets', 'MarcarTablets', 1, 1, 4, 6, '', 65),
('¿Qué Distribuidor/es le venden los Impresion habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtDistribuidorImpresion', 'DistribuidorImpresion', 1, 1, 6, 5, '', 76),
('¿Qué Distribuidor/es le venden los LFD habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtDistribuidorLFD', 'DistribuidorLFD', 1, 1, 7, 5, '', 82),
('¿Qué Distribuidor/es le venden los Moviles habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtDistribuidorMoviles', 'DistribuidorMoviles', 1, 1, 5, 5, '', 70),
('¿Qué Distribuidor/es le venden los PCs habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtDistribuidorPCs', 'DistribuidorPCs', 1, 1, 3, 5, '', 58),
('¿Qué Distribuidor/es le venden los Tablets habitualmente?', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtDistribuidorTablets', 'DistribuidorTablets', 1, 1, 4, 5, '', 64),
('¿Tiene proyecto de Impresion?', 'VARCHAR', 50, 'SELECT', 5, 0, 'txtProyectoImpresion', 'ProyectoImpresion', 1, 1, 6, 1, '', 72),
('¿Tiene proyecto de LFD?', 'VARCHAR', 50, 'SELECT', 5, 0, 'txtProyectoLFD', 'ProyectoLFD', 1, 1, 7, 1, '', 78),
('¿Tiene proyecto de Moviles?', 'VARCHAR', 50, 'SELECT', 5, 0, 'txtProyectoMoviles', 'ProyectoMoviles', 1, 1, 5, 1, '', 66),
('¿Tiene proyecto de PCs?', 'VARCHAR', 50, 'SELECT', 5, 0, 'txtProyectoPCs', 'ProyectoPCs', 1, 1, 3, 1, '', 54),
('¿Tiene proyecto de Tablets?', 'VARCHAR', 50, 'SELECT', 5, 0, 'txtProyectoTablets', 'ProyectoTablets', 1, 1, 4, 1, '', 60),
('Actividad', 'VARCHAR', 100, 'TEXT', 5, 0, 'txtActividad', 'Actividad', 1, 1, 1, 5, '', 0),
('ACTIVIDADNEGOCIAL', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'ACTIVIDADNEGOCIAL', 0, 1, 0, 0, '', 24),
('Actualizar Datos en BBDD', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtActualizarDatosBBDD', 'ActualizarDatosBBDD', 1, 1, 2, 5, '', 50),
('APELLIDO1CARGO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'APELLIDO1CARGO', 0, 1, 0, 0, '', 38),
('APELLIDO2CARGO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'APELLIDO2CARGO', 0, 1, 0, 0, '', 39),
('BLOQUE', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'BLOQUE', 0, 1, 0, 0, '', 11),
('Calidad BBDD', 'VARCHAR', 50, 'SELECT', 5, 0, 'txtCalidadBBDD', 'CalidadBBDD', 1, 1, 2, 3, '', 48),
('CALLE', 'VARCHAR', 255, 'TEXT', 5, 0, '', 'CALLE', 0, 1, 0, 0, '', 9),
('CC.AA.', 'VARCHAR', 80, 'TEXT', 5, 0, 'txtCCAA', 'CCAA', 1, 1, 1, 28, '', 0),
('CIF', 'VARCHAR', 10, 'TEXT', 5, 1, 'txtCIF', 'CIF', 1, 0, 1, 1, '', 5),
('CODACTR2', 'VARCHAR', 50, 'NUMBER', 5, 0, '', 'CODACTR2', 0, 1, 0, 0, '', 22),
('CODAREACARGO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'CODAREACARGO', 0, 1, 0, 0, '', 0),
('CODCARGO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'CODCARGO', 0, 1, 0, 0, '', 0),
('CODEMPLEADOS', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'CODEMPLEADOS', 0, 1, 0, 0, '', 0),
('CODINGRESOS', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'CODINGRESOS', 0, 1, 0, 0, '', 0),
('CODMERCADO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'CODMERCADO', 0, 1, 0, 0, '', 25),
('CODPERSONA', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'CODPERSONA', 0, 1, 0, 0, '', 0),
('COMPLEMENTO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'COMPLEMENTO', 0, 1, 0, 0, '', 15),
('CP', 'VARCHAR', 5, 'TEXT', 5, 0, 'txtCP', 'CP', 1, 1, 1, 24, '', 17),
('Dirección', 'VARCHAR', 150, 'TEXT', 5, 0, 'txtDireccion', 'Direccion', 1, 1, 1, 23, '', 16),
('ESCALERA', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'ESCALERA', 0, 1, 0, 0, '', 14),
('Facturación', 'VARCHAR', 50, 'TEXT', 5, 0, 'txtFacturacion', 'Facturacion', 0, 1, 1, 6, '', 0),
('Fecha de Llamada', 'DATE', 0, 'DATE', 5, 0, 'txtFechallamada', 'Fechallamada', 1, 1, 2, 1, '', 46),
('Fecha de Seguimiento', 'DATE', 0, 'DATE', 5, 0, 'txtFechaSeguimiento', 'FechaSeguimiento', 0, 1, 2, 6, '', 51),
('Fecha Estimada Compra Impresion', 'DATE', 0, 'DATE', 5, 0, 'txtFechaEstimadaCompraImpresion', 'FechaEstimadaCompraImpresion', 1, 1, 6, 4, '', 75),
('Fecha Estimada Compra LFD', 'DATE', 0, 'DATE', 5, 0, 'txtFechaEstimadaCompraLFD', 'FechaEstimadaCompraLFD', 1, 1, 7, 4, '', 81),
('Fecha Estimada Compra Moviles', 'DATE', 0, 'DATE', 5, 0, 'txtFechaEstimadaCompraMoviles', 'FechaEstimadaCompraMoviles', 1, 1, 5, 4, '', 69),
('Fecha Estimada Compra PCs', 'DATE', 0, 'DATE', 5, 0, 'txtFechaEstimadaCompraPCs', 'FechaEstimadaCompraPCs', 1, 1, 3, 4, '', 57),
('Fecha Estimada Compra Tablets', 'DATE', 0, 'DATE', 5, 0, 'txtFechaEstimadaCompraTablets', 'FechaEstimadaCompraTablets', 1, 1, 4, 4, '', 63),
('Grupo Empresarial', 'VARCHAR', 50, 'TEXT', 5, 0, 'txtGrupoEmpresarial', 'GrupoEmpresarial', 1, 1, 1, 4, '', 0),
('JUANAN', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'JUANAN', 0, 1, 0, 0, '', 3),
('JULIO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'JULIO', 0, 1, 0, 0, '', 4),
('Lead', 'VARCHAR', 50, 'SELECT', 5, 0, 'txtLead', 'Lead', 1, 1, 2, 8, '', 53),
('LITACTR2', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'LITACTR2', 0, 1, 0, 0, '', 23),
('LITAREACARGO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'LITAREACARGO', 0, 1, 0, 0, '', 45),
('LITCARGO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'LITCARGO', 0, 1, 0, 0, '', 43),
('LITMERCADO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'LITMERCADO', 0, 1, 0, 0, '', 26),
('LITOFICINA', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'LITOFICINA', 0, 1, 0, 0, '', 0),
('LITSEXO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'LITSEXO', 0, 1, 0, 0, '', 21),
('Nº de Llamadas Realizadas', 'INT', 2, 'SELECT', 5, 0, 'txtNumLlamadasRealizadas', 'NumLlamadasRealizadas', 1, 1, 2, 2, '', 47),
('Nº de PCs Empresa', 'INT', 4, 'NUMBER', 5, 0, 'txtNumPCsEmpresa', 'NumPCsEmpresa', 1, 1, 1, 8, '', 0),
('Nº Empleados', 'INT', 4, 'NUMBER', 5, 0, 'txtNumEmpleados', 'NumEmpleados', 1, 1, 1, 7, '', 0),
('Nº Impresion', 'INT', 50, 'NUMBER', 5, 0, 'txtNumImpresion', 'NumImpresion', 1, 1, 6, 2, '', 73),
('Nº LFD', 'INT', 50, 'NUMBER', 5, 0, 'txtNumLFD', 'NumLFD', 1, 1, 7, 2, '', 79),
('Nº Moviles', 'INT', 50, 'NUMBER', 5, 0, 'txtNumMoviles', 'NumMoviles', 1, 1, 5, 2, '', 67),
('Nº PCs', 'INT', 50, 'NUMBER', 5, 0, 'txtNumPCs', 'NumPCs', 1, 1, 3, 2, '', 55),
('Nº Tablets', 'INT', 50, 'TEXT', 5, 0, 'txtNumTablets', 'NumTablets', 1, 1, 4, 2, '', 61),
('Nombre Comercial', 'VARCHAR', 150, 'TEXT', 5, 0, 'txtNombreComercial', 'NombreComercial', 1, 1, 1, 3, '', 7),
('Nombre Fiscal', 'VARCHAR', 150, 'TEXT', 5, 0, 'txtNombreFiscal', 'NombreFiscal', 1, 1, 1, 2, '', 6),
('NOMBRECARGO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'NOMBRECARGO', 0, 1, 0, 0, '', 37),
('NOMBREENTERO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'NOMBREENTERO', 0, 1, 0, 0, '', 0),
('NUMERO', 'VARCHAR', 50, 'NUMBER', 5, 0, '', 'NUMERO', 0, 1, 0, 0, '', 10),
('NUMSCH', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'NUMSCH', 0, 1, 0, 0, '', 2),
('Opp Impresion €', 'VARCHAR', 50, 'MONEDA', 5, 0, 'txtOppImpresion', 'OppImpresion', 1, 0, 6, 3, '', 74),
('Opp LFD €', 'VARCHAR', 50, 'MONEDA', 5, 0, 'txtOppLFD', 'OppLFD', 1, 0, 7, 3, '', 80),
('Opp Moviles €', 'VARCHAR', 50, 'MONEDA', 5, 0, 'txtOppMoviles', 'OppMoviles', 1, 0, 5, 3, '', 68),
('Opp PCs €', 'VARCHAR', 50, 'MONEDA', 5, 0, 'txtOppPCs', 'OppPCs', 1, 0, 3, 3, '', 56),
('Opp Tablets €', 'VARCHAR', 50, 'TEXT', 5, 0, 'txtOppTablets', 'OppTablets', 1, 0, 4, 3, '', 62),
('PISO', 'VARCHAR', 255, 'TEXT', 5, 0, '', 'PISO', 0, 1, 0, 0, '', 12),
('Población', 'VARCHAR', 50, 'TEXT', 5, 0, 'txtPoblacion', 'Poblacion', 1, 1, 1, 26, '', 19),
('Polígono', 'VARCHAR', 255, 'TEXT', 5, 0, 'txtPoligono', 'POLIGONO', 0, 1, 1, 25, '', 18),
('Provincia', 'VARCHAR', 100, 'TEXT', 5, 0, 'txtProvincia', 'Provincia', 1, 1, 1, 27, '', 20),
('PUERTA', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'PUERTA', 0, 1, 0, 0, '', 13),
('Resultado de la Llamada', 'VARCHAR', 50, 'SELECT', 5, 0, 'txtResultadoLlamada', 'ResultadoLlamada', 1, 1, 2, 4, '', 49),
('Resumen de la Conversación', 'TEXT', 0, 'TEXTAREA', 300, 0, 'txtResumenConversacion', 'ResumenConversacion', 1, 1, 2, 7, '', 52),
('SEXOCARGO', 'VARCHAR', 50, 'TEXT', 5, 0, '', 'SEXOCARGO', 0, 1, 0, 0, '', 41),
('TELEFONO1', 'VARCHAR', 50, 'TEL', 5, 0, '', 'TELEFONO1', 0, 1, 0, 0, '', 29),
('TELEFONO2', 'VARCHAR', 50, 'TEL', 5, 0, '', 'TELEFONO2', 0, 1, 0, 0, '', 30),
('TELEFONO3', 'VARCHAR', 50, 'TEL', 5, 0, '', 'TELEFONO3', 0, 1, 0, 0, '', 0),
('TELEFONO4', 'VARCHAR', 50, 'TEL', 5, 0, '', 'TELEFONO4', 0, 1, 0, 0, '', 0),
('TELEFONO5', 'VARCHAR', 50, 'TEL', 5, 0, '', 'TELEFONO5', 0, 1, 0, 0, '', 0),
('TOP', 'VARCHAR', 20, 'TEXT', 5, 0, '', 'TOP', 0, 1, 0, 0, '', 1),
('URL', 'VARCHAR', 255, 'TEXT', 5, 0, '', 'URL', 0, 1, 0, 0, '', 0),
('VIA', 'VARCHAR', 255, 'TEXT', 5, 0, '', 'VIA', 0, 1, 0, 0, '', 8);
...
CREATE TABLE IF NOT EXISTS `samsung` (
  ...
  `NombreFiscal` varchar(150) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `NombreComercial` varchar(150) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `GrupoEmpresarial` varchar(50) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `Actividad` varchar(100) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `Facturacion` varchar(50) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `NumEmpleados` int(4) DEFAULT NULL,
  `NumPCsEmpresa` int(4) DEFAULT NULL,
  ...
  `Poblacion` varchar(50) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `Provincia` varchar(100) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `CCAA` varchar(80) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
('', NULL, 'LUGAR', '', 'FINCA DEHESILLA', '', '', '', '0 S-N', '003440906', '', 'EMPRESA', '2512', NULL, '', 'FRUTAS VERDURAS Y FRUTAS EXOTICAS MAY', 'DIRECTOR DE RECURSOS HUMANOS', 'HOMBRE', '959385236', '959394323', NULL, NULL, NULL, '46', NULL, 'ALIMENTACION Y BEBIDAS', NULL, NULL, '', 'ANTONIO', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'INFANTE', '', '', 'A21362389', 'CITRICOS DEL ANDEVALO SA.', '', '', '', '', 0, 0, 'LUGAR FINCA DEHESILLA S-N', '21540', '', 'VILLANUEVA DE LOS CASTILLEJOS', 'HUELVA', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'CARRER', '5º', 'ALMOGAVERS', '', '', '', '107', '001007285', '', 'EMPRESA', '0761', NULL, '', 'ELECTRODOMESTICOS FAB', 'DIRECTOR DE RECURSOS HUMANOS', 'MUJER', '932922122', '', NULL, NULL, NULL, '34', NULL, 'ELECTRICIDAD Y ELECTRONICA', NULL, NULL, 'EDIF ECOURBAN', 'MARINA', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'TARRADELLAS', '', '', 'A58153990', 'TEFAL ESPAÑA S.A.', '', '', '', '', 0, 0, 'CARRER ALMOGAVERS, 107 5º EDIF ECOURBAN', '08018', '', 'BARCELONA', 'BARCELONA', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('Lola', NULL, 'CARRER', 'B', 'NARCIS MONTURIOL I ESTARRIOL', 'Named', '', '', '17', '001241199', '', 'EMPRESA', '2310', NULL, '', 'MAQUINARIA EQUIPOS Y APARATOS MAY COM', 'DIRECTOR DE INFORMATICA', 'HOMBRE', '963604180', '963604247', NULL, NULL, NULL, '42', NULL, 'MAQUINARIA, EQUIPO Y APARATOS', NULL, NULL, 'PQUE TECNOLOGICO EDIF AS CENTER 3 AZUL', 'JAVIER', NULL, NULL, 'INFORMATICA', NULL, 'SANCHEZ', '', '', 'A58399767', 'ABB METRON S.A.', 'a', 'b', 'c', '1', 0, 0, 'CARRER NARCIS MONTURIOL I ESTARRIOL, 17 B PQUE TECNOLOGICO EDIF AS CENTER 3 AZUL', '46980', 'e', 'PATERNA', 'VALENCIA', 'Comunidad Valenciana', '2013-10-20', 4, 'SinCambios', 'CUVisitaSi', '1', '0000-00-00', 'klklk´l lklkl', 'Sí', 'No', 4, '4', '0000-00-00', 'aasd', 'adssaada', 'No', 3, '3', '0000-00-00', 'fdfas', 'dfasdf', 'Sí', 2, '22', '2013-01-10', 'fsfsd', 'asfdsfsd', 'No', 323, '2342423', '0000-00-00', 'dsadsfdsf', 'adsfsdf', 'No', 23, '3', '0000-00-00', 'dfaf', 'adfdfdsfsdf', 'insidesalesR@b2bss.es'),
('', NULL, 'CARRER', '', 'PROVENÇALS', '', '', '', '39', '003659521', '', 'EMPRESA', '2197', NULL, '', 'AGENTES INMOBILIARIOS', '', '', '934133200', '932933030', NULL, NULL, NULL, '15', NULL, 'EMPRESAS DE SERVICIOS', NULL, NULL, '', '', NULL, NULL, '', NULL, '', '', '', 'A63379135', 'SERVIHABITAT XXI SA', '', '', '', '', 0, 0, 'CARRER PROVENÇALS, 39', '08019', '', 'BARCELONA', 'BARCELONA', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'POLIGONO', '', 'INDUSTRIAL MIRALCAMPO', '', '', '', '12', '001699123', '', 'EMPRESA', '0381', NULL, '', 'CERVEZA MAY', 'DIRECTOR DE RECURSOS HUMANOS', 'HOMBRE', '949264426', '949264424', NULL, NULL, NULL, '46', NULL, 'ALIMENTACION Y BEBIDAS', NULL, NULL, '', 'ANDRES', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'GARCIA', '', '', 'A80684111', 'GMODELO EUROPA SA', '', '', '', '', 0, 0, 'POLIGONO INDUSTRIAL MIRALCAMPO, 12', '19200', 'POLÍGONO INDUSTRIAL MIRALCAMPO', 'AZUQUECA DE HENARES', 'GUADALAJARA', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'AVENIDA', '', 'PARTENON', '', '', '', '12', '001723766', '', 'EMPRESA', '0768', NULL, '', 'PRODUCCION DE ENERGIA ELECTRICA', 'JEFE DE COMPRAS', 'HOMBRE', '913379518', '913376000', NULL, NULL, NULL, '16', NULL, 'ENERGIA Y AGUA', NULL, NULL, '', 'JAVIER', NULL, NULL, 'COMPRAS', NULL, 'MARTINEZ', '', '', 'A83491019', 'GENERACION ELECTRICA PENINSULAR S.A.', '', '', '', '', 0, 0, 'AVENIDA PARTENON, 12', '28042', '', 'MADRID', 'MADRID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'CARRETERA', '', 'N - 332', '', '', '', '0', '003614559', '', 'EMPRESA', '1168', NULL, '', 'ZUMOS DE FRUTA FAB', 'DIRECTOR DE COMPRAS', 'HOMBRE', '962850200', '962838425', NULL, NULL, NULL, '46', NULL, 'ALIMENTACION Y BEBIDAS', NULL, NULL, 'KM 206.900', 'VICTOR', NULL, NULL, 'COMPRAS', NULL, 'MORCUENDE', '', '', 'A83745695', 'REFRESCO IBERIA SA', '', '', '', '', 0, 0, 'CARRETERA N - 332 KM 206.900', '46780', '', 'OLIVA', 'VALENCIA', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('Lola', NULL, 'CALLE', '', 'VELAZQUEZ', '', '', 'Named', '132', '004108064', '', 'EMPRESA', '2884', NULL, '', 'BARCOS Y BUQUES FAB', 'DIRECTOR DE INFORMATICA', 'HOMBRE', '913358553', '913358400', NULL, NULL, NULL, '35', NULL, 'VEHICULOS, RECAMBIOS Y ACCESORIOS', NULL, NULL, '', 'PEDRO ANTONIO', NULL, NULL, 'INFORMATICA', NULL, 'MARTINEZ', '', '', 'A84076397', 'NAVANTIA SA', '', '', '', '', 0, 0, 'VELAZQUEZ, 132', '28006', '', 'MADRID', 'MADRID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'CARRER', '3º', 'JOSEP ROVER MOTTA', '', '', '', '27', '001821891', '', 'EMPRESA', '0656', NULL, '', 'TURISMO SERVICIOS', 'DIRECTOR DE RECURSOS HUMANOS', 'MUJER', '971771700', '', NULL, NULL, NULL, '15', NULL, 'EMPRESAS DE SERVICIOS', NULL, NULL, '', 'MARIA CARMEN', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'OLIVER', '', '', 'B07067564', 'AUXILIAIR S.L.', NULL, NULL, NULL, NULL, NULL, NULL, 'CARRER JOSEP ROVER MOTTA, 27 3º', '07006', 'POLÍGONO INDUSTRIAL SON CASTELLÓ', 'PALMA', 'BALEARES', NULL, '2013-10-21', NULL, NULL, NULL, NULL, '2013-10-31', NULL, NULL, NULL, NULL, '0', '0000-00-00', NULL, NULL, NULL, NULL, '0', '0000-00-00', NULL, NULL, NULL, NULL, '0', '0000-00-00', NULL, NULL, NULL, NULL, '0', '0000-00-00', NULL, NULL, NULL, NULL, '0', '0000-00-00', NULL, NULL, 'insidesalesR@b2bss.es'),
('', NULL, 'VIAL', '', 'SAN JOSE', '', '', '', '0 S-N', '001859180', '', 'EMPRESA', '0211', NULL, '', 'AUTOMOVILES ALQUILER', '', '', '971126844', '971126970', NULL, NULL, NULL, '15', NULL, 'EMPRESAS DE SERVICIOS', NULL, NULL, 'VIAL 1 SOLAR 3 Y 4 LO 2', '', NULL, NULL, '', NULL, '', '', '', 'B07947591', 'SIXT RENT A CAR SL', '', '', '', '', 0, 0, 'VIAL SAN JOSE S-N VIAL 1 SOLAR 3 Y 4 LO 2', '07009', 'POLÍGONO INDUSTRIAL SON CASTELLÓ', 'PALMA', 'BALEARES', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'AVENIDA', '', 'SANTANDER', '', '', '', '2', '003782240', '', 'EMPRESA', '2390', NULL, '', 'LECHE Y DERIVADOS DE LECHE FAB', 'DIRECTOR DE RECURSOS HUMANOS', 'HOMBRE', '983250450', '983320384', NULL, NULL, NULL, '46', NULL, 'ALIMENTACION Y BEBIDAS', NULL, NULL, 'NAVE', 'TOMAS', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'BARRIGA', '', '', 'B27313899', 'INDUSTRIAS LACTEAS VALLISOLETANAS SL', '', '', '', '', 0, 0, 'AVENIDA SANTANDER, 2 NAVE', '47010', '', 'VALLADOLID', 'VALLADOLID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'CARRER', '', 'MARIA CURIE', '', '', '', '6', '002897502', '', 'EMPRESA', '2151', NULL, '', 'AGRICULTURA', '', '', '937733800', '937741441', NULL, NULL, NULL, '56', NULL, 'AGRICULTURA Y PESCA', NULL, NULL, '', '', NULL, NULL, '', NULL, '', '', '', 'B62583471', 'CARGILL SL', '', '', '', '', 0, 0, 'CARRER MARIA CURIE, 6', '08760', 'POLÍGONO INDUSTRIAL LA TORRE', 'MARTORELL', 'BARCELONA', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'AUTOVIA', 'BJ', 'A - 2', '', '', '', '0', '002918530', '', 'EMPRESA', '1919', NULL, '', 'VIAJES AGENCIAS', 'DIRECTOR DE RECURSOS HUMANOS', 'MUJER', '937677930', '963767793', NULL, NULL, NULL, '21', NULL, 'TRANSPORTES Y TRAFICO', NULL, NULL, 'KM 672.500', 'CRISTINA', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'SAULEDA', '', '', 'B62880992', 'N T INCOMING SL', '', '', '', '', 0, 0, 'AUTOVIA A - 2 BJ KM 672.500', '08398', '', 'CASC URBA - SANTA SUSANNA', 'BARCELONA', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'AVENIDA', '', 'ANDALUCIA', '', '', '', '0', '003074622', '', 'EMPRESA', '2390', NULL, '', 'LECHE Y DERIVADOS DE LECHE FAB', 'DIRECTOR DE INFORMATICA', 'HOMBRE', '958274050', '958277071', NULL, NULL, NULL, '46', NULL, 'ALIMENTACION Y BEBIDAS', NULL, NULL, 'NAVE', 'JOSE', NULL, NULL, 'INFORMATICA', NULL, 'PUENTE', '', '', 'B81576985', 'GRUPO DHUL S.L.', '', '', '', '', 0, 0, 'AVENIDA ANDALUCIA NAVE', '18015', '', 'GRANADA', 'GRANADA', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'CAMINO', '', 'ZARZUELA', '', '', '', '15', '003120508', '', 'EMPRESA', '1575', NULL, '', 'INMOBILIARIAS AGENCIAS Y AGENTES', 'DIRECTOR DE MARKETING', 'MUJER', '914576070', '916253000', NULL, NULL, NULL, '15', NULL, 'EMPRESAS DE SERVICIOS', NULL, NULL, '', 'RAQUEL', NULL, NULL, 'MARKETING', NULL, 'BRAVO', '', '', 'B82219999', 'GRUPO EMPRESARIAL PINAR SL', '', '', '', '', 0, 0, 'CAMINO ZARZUELA, 15', '28023', '', 'MADRID', 'MADRID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'PASEO', '', 'CASTELLANA', '', '', '', '123', '003131802', '', 'EMPRESA', '1575', NULL, '', 'INMOBILIARIAS AGENCIAS Y AGENTES', 'DIRECTOR DE RECURSOS HUMANOS', 'HOMBRE', '913915002', '', NULL, NULL, NULL, '15', NULL, 'EMPRESAS DE SERVICIOS', NULL, NULL, '', 'DAVID', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'LAMOTE', '', '', 'B82354713', 'PIK POBEDY PROMOCIONES S.L.', '', '', '', '', 0, 0, 'PASEO CASTELLANA, 123', '28046', '', 'MADRID', 'MADRID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('Lola', NULL, 'CARRETERA', '', 'VILLAVERDE A VALLECAS', '', '', 'Named', '257', '003753381', '', 'EMPRESA', '3350', NULL, '', 'TRANSPORTES URBANOS DE MERCANCIAS', 'DIRECTOR DE RECURSOS HUMANOS', 'HOMBRE', '913228080', '913320802', NULL, NULL, NULL, '21', NULL, 'TRANSPORTES Y TRAFICO', NULL, NULL, '', 'ANTONIO', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'MARTINEZ', 'GARCIA', '', 'B82516600', 'SEUR GEOPOST SL', '', '', '', '', 0, 0, 'CARRETERA VILLAVERDE A VALLECAS, 257', '28031', '', 'MADRID', 'MADRID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'LEKU', '', 'BARRIO TRAPAGA', '', '', '', '0 S-N', '003180189', '', 'EMPRESA', '2874', NULL, '', 'VEHICULOS FERROVIARIOS FAB', 'DIRECTOR DE RECURSOS HUMANOS', 'HOMBRE', '944869100', '944869128', NULL, NULL, NULL, '35', NULL, 'VEHICULOS, RECAMBIOS Y ACCESORIOS', NULL, NULL, '', 'IÑAQUI', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'ROJO', 'MARTIN', '', 'B82894049', 'BOMBARDIER EUROPEAN HOLDINGS S.L.', '', '', '', '', 0, 0, 'BARRIO TRAPAGA LEKU S-N', '48510', 'POLÍGONO INDUSTRIAL TRÁPAGA UGARTE', 'VALLE DE TRAPAGA - TRAPAGARAN', 'VIZCAYA', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'CAMINO', '', 'HORMIGUERAS', '', '', '', '171', '003604584', '', 'EMPRESA', '1049', NULL, '', 'ASESORES FINANCIEROS Y DE INVERSIONES', 'DIRECTOR DE COMPRAS', 'HOMBRE', '916424580', '913057019', NULL, NULL, NULL, '27', NULL, 'ASESORIA JURIDICA, ECONOMICA Y NOTARIAS', NULL, NULL, '', 'RUBEN', NULL, NULL, 'COMPRAS', NULL, 'TORRADO', '', '', 'B83667725', 'SERTEGO SERVICIOS MEDIOAMBIENTALES SL', '', '', '', '', 0, 0, 'CAMINO HORMIGUERAS, 171', '28031', 'POLÍGONO INDUSTRIAL DE VALLECAS', 'MADRID', 'MADRID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'PLAZA', '', 'CARLOS TRIAS BERTRAN', '', '', '', '7', '003247301', '', 'EMPRESA', '3287', NULL, '', 'OBRAS PUBLICAS', 'JEFE DE COMPRAS', 'HOMBRE', '914170800', '915455000', NULL, NULL, NULL, '5', NULL, 'CONSTRUCCION Y OBRAS PUBLICAS', NULL, NULL, '', 'MANUEL', NULL, NULL, 'COMPRAS', NULL, 'CESPEDOSA', '', '', 'B83681247', 'ENAITINERE SL.', '', '', '', '', 0, 0, 'PLAZA CARLOS TRIAS BERTRAN, 7', '28020', '', 'MADRID', 'MADRID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
('', NULL, 'CALLE', '', 'MIGUEL YUSTE', '', '', '', '45', '003710381', '', 'EMPRESA', '3908', NULL, '', 'OBRAS Y SERVICIOS', 'DIRECTOR DE INFORMATICA', 'HOMBRE', '914237511', '914237500', NULL, NULL, NULL, '14', NULL, 'DISEÑO Y SERVICIOS DE CONSTRUCCION', NULL, NULL, '', 'ALEJANDRO', NULL, NULL, 'INFORMATICA', NULL, 'SIERRA', '', '', 'B83901041', 'TERRATEST CIMENTACIONES SL.', '', '', '', '', 0, 0, 'MIGUEL YUSTE, 45', '28037', 'POLÍGONO INDUSTRIAL JULIÁN CAMARILLO', 'MADRID', 'MADRID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
...
('', NULL, 'CALLE', '', 'FEDERICO MOMPOU', '', '', '', '5', '004134813', '', 'EMPRESA', '4383', NULL, '', 'SERVICIOS TELEMATICOS', 'DIRECTOR DE RECURSOS HUMANOS', 'MUJER', '913843888', '913841020', NULL, NULL, NULL, '65', NULL, 'TELECOMUNICACIONES', NULL, NULL, '', 'NATALIA', NULL, NULL, 'RECURSOS HUMANOS', NULL, 'WISTER', '', '', 'B84136464', 'HUAWEI TECHNOLOGIES ESPAÑA S.L.', '', '', '', '', 0, 0, 'FEDERICO MOMPOU, 5', '28050', 'PARQUE EMPRESARIAL CERRO DE LAS CUEVAS', 'MADRID', 'MADRID', '', NULL, NULL, '', '', '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', '', NULL, '', NULL, '', '', 'insidesalesR@b2bss.es'),
...
(4, 'A58399767', 'JAVIER', 'SANCHEZ', 'DIRECTOR DE INFORMATICA', 'INFORMATICA', 'prueba@prueba.es', '963604180', '963604247', 'H'),
...
(8, 'txtCalidadBBDD', 'Telf Erróneo', 'TelfErroneo', 2),
(9, 'txtCalidadBBDD', 'Contacto Erróneo', 'ContactoErroneo', 3),
(10, 'txtCalidadBBDD', 'Telf+Contacto Erróneo', 'TelfYcontactoErroneo', 4),
...
(38, 'txtCalidadBBDD', 'Sin Cambios', 'SinCambios', 1);
