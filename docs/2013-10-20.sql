...
--
-- Servidor: localhost
-- Tiempo de generación: 19-10-2013 a las 22:31:09
...
('CIF', 'VARCHAR', 10, 'TEXT', 5, 1, 'txtCIF', 'CIF', 1, 1, 1, 1, '', 5),
...
('Opp Impresion €', 'VARCHAR', 50, 'MONEDA', 5, 0, 'txtOppImpresion', 'OppImpresion', 1, 1, 6, 3, '', 74),
('Opp LFD €', 'VARCHAR', 50, 'MONEDA', 5, 0, 'txtOppLFD', 'OppLFD', 1, 1, 7, 3, '', 80),
('Opp Moviles €', 'VARCHAR', 50, 'MONEDA', 5, 0, 'txtOppMoviles', 'OppMoviles', 1, 1, 5, 3, '', 68),
('Opp PCs €', 'VARCHAR', 50, 'MONEDA', 5, 0, 'txtOppPCs', 'OppPCs', 1, 1, 3, 3, '', 56),
('Opp Tablets €', 'VARCHAR', 50, 'TEXT', 5, 0, 'txtOppTablets', 'OppTablets', 1, 1, 4, 3, '', 62),
('PISO', 'VARCHAR', 255, 'TEXT', 5, 0, '', 'PISO', 0, 1, 0, 0, '', 12),
('Población', 'VARCHAR', 50, 'TEXT', 5, 0, 'txtPoblacion', 'Poblacion', 1, 1, 1, 26, '', 19),
('Polígono', 'VARCHAR', 255, 'TEXT', 5, 0, '', 'POLIGONO', 0, 1, 1, 25, '', 18),
